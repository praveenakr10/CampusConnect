...
module.exports = {
  ...
  DEMO_DAILY_API_LIMIT: Number(process.env.DEMO_DAILY_API_LIMIT || 5),
  DAILY_UPLOAD_LIMIT: Number(process.env.DAILY_UPLOAD_LIMIT || 5),
  DAILY_AI_LIMIT: Number(process.env.DAILY_AI_LIMIT || 5),
